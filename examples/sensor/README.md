Uses the Data Relay block to push data from the [balenablocks/sensor](https://github.com/balenablocks/sensor) block to a cloud provider's message queue. No user code required!
